// Header — Space Grotesk logo, onglets épurés, bouton SIM redesigné
  ...
  return (
    <LazyMotion features={domAnimation}>
      ...
      >
        ...
        {/* Simulation progress + SIM button */}
        <div
            ...
            {isSimRunning && (
              ...
              >
                <div
                  ...
                  style={{ width: 96, height: 1, background: 'var(--color-rule)' }}
                >
                  <div
                ...
                <span
                  style={{ fontFamily: 'var(--font-mono)', fontSize: 10, color: 'var(--color-ink-4)' }}
                >
