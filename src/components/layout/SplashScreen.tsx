// SplashScreen — page de garde architecturale futuriste
    ...
    <LazyMotion features={domAnimation}>
      ...
      >
        ...
        >
          ...
          <m.div
            variants={item}
            className="relative flex items-center justify-center mt-5 mb-4"
            style={{ width: 120 }}
          >
            ...
            <div
              ...
              style={{
                ...
                height: 3,
                borderRadius: '50%',
                background: 'rgba(232,228,218,0.35)',
              }}
            />
          </m.div>
          ...
          >
            ...
            simulée à la précision du réel.
          </m.p>
